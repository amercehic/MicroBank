...
namespace Client.Infrastructure.Data
{
    public class ClientDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<Core.Entities.Client.PersonalClient>().HasQueryFilter(m => EF.Property<bool>(m, "IsDeleted") == false);
            builder.Entity<Core.Entities.Client.RejectedClientApplication>().HasQueryFilter(m => EF.Property<bool>(m, "IsDeleted") == false);
        }

        public DbSet<Core.Entities.Client.PersonalClient> PersonalClients { get; set; }
