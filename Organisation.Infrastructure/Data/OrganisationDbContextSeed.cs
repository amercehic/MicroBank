...
{
    public static class OrganisationDbContextSeed
    {
        public static async Task SeedAsync(OrganisationDbContext context, ILoggerFactory loggerFactory, int? retry = 0)
        {
...
#pragma warning restore CA1031 // Do not catch general exception types
            {
                if (retryForAvailability < 10)
                {
                    ...
                    var log = loggerFactory.CreateLogger<OrganisationDbContext>();
